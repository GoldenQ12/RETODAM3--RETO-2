...
public class Empleados_DAO {
	...
	private static final String SQL_SELECT_COLOR= "SELECT Color FROM empleadosChat WHERE Nombre = ?";
	private static final String SQL_SELECT_COLORFONDO	= "SELECT colorFondo FROM empleadosChat WHERE Nombre = ?";
	private static final String SQL_UPDATE_COLOR = "UPDATE empleadosChat SET Color = ? WHERE Nombre = ?";
	private static final String SQL_UPDATE_COLORFONDO = "UPDATE empleadosChat SET colorFondo = ? WHERE Nombre = ?";
	...
	public String obtenerColor(String nombre) throws SQLException {
        ...
        try (PreparedStatement statement = con.getCon().prepareStatement(SQL_SELECT_COLOR)) {
